...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::middleware('super-admin')->group(function () {
        Route::get('/area-management', [AreaManagementController::class, 'index'])->name('admin.area-management');
        Route::put('/area-management/{area}/owner', [AreaManagementController::class, 'updateOwner'])->name('admin.area.update-owner');
        Route::post('/transfer-super-admin/{user}', [\App\Http\Controllers\Admin\UserManagementController::class, 'transferSuperAdmin'])->name('admin.transfer-super-admin');
    });
