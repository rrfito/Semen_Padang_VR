        ...
        <div className="h-screen w-screen flex overflow-hidden bg-gray-900 font-sans">
            ...
            <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-black">
                ...
                <div className="relative z-10 flex flex-col justify-between p-16 w-full h-full text-white">
                    <div>
                        <img src="/image/LOGO PT SEMEN PADANG.png" alt="Semen Padang" className="h-20 w-auto drop-shadow-2xl" />
                    </div>
                    <div className="space-y-6">
                        ...
                        <p className="text-xl text-gray-200 max-w-lg drop-shadow-md">
                            Jelajahi setiap sudut fasilitas Semen Padang dengan pengalaman 360° yang imersif dan detail.
                        </p>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#0f172a] relative h-full">
                ...
                <div className="absolute inset-0 lg:hidden bg-cover bg-center opacity-20"
                     style={{ backgroundImage: "url('/image/BG-Semen_Padang.jpg')" }}>
                </div>
                ...
                <div className="w-full max-w-md space-y-8 relative z-10 backdrop-blur-sm lg:backdrop-blur-none p-6 lg:p-0 rounded-2xl lg:rounded-none border border-white/5 lg:border-none bg-black/20 lg:bg-transparent">
                    <div className="text-center lg:text-left">
                        {/* Mobile Logo */}
                        <img src="/image/LOGO PT SEMEN PADANG.png" alt="Semen Padang" className="h-12 w-auto mx-auto lg:hidden mb-6 drop-shadow-lg" />
                        
                        <h2 className="text-3xl font-bold text-white tracking-tight">Selamat Datang</h2>
                        <p className="mt-2 text-gray-400">Silakan masuk untuk mengakses dashboard pegawai.</p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center">
                                ...
                                />
                                <span className="ms-2 text-sm text-gray-400 hover:text-gray-300 cursor-pointer">Ingat saya</span>
                            </label>
                    ...
                    <div className="text-center mt-6">
                        <p className="text-sm text-gray-500">
                            Bukan pegawai? <Link href="/" className="text-white hover:text-red-500 font-medium transition-colors">Kembali ke Beranda</Link>
                        </p>
                    </div>
                </div>
            </div>
