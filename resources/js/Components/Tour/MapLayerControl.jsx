...
export default function MapLayerControl({ currentLayer, onChangeLayer, isSidebarOpen }) {
        ...
        >
            ...
            <button
                ...
                className={`
                    ...
                    ${!isSatellite ? 'border-blue-600 ring-2 ring-blue-400 scale-105' : 'border-white opacity-80 hover:opacity-100 hover:scale-105'}
                `}
            >
                ...
                <div className="absolute inset-x-0 bottom-0 bg-black/60 backdrop-blur-sm py-1">
                    <span className={`text-[10px] font-bold text-white uppercase tracking-wider ${!isSatellite ? 'text-blue-200' : ''}`}>
                        Peta
                    </span>
                </div>
            </button>
