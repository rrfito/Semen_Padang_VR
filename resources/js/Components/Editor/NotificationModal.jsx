...
export default function NotificationModal({ 
    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] p-4">
            <div className={`bg-surface-dark rounded-xl shadow-2xl max-w-md w-full border ${style.borderColor} animate-in fade-in zoom-in duration-200`}>
                ...
                {autoClose > 0 && (
                    <div className="h-1 bg-slate-800 rounded-b-xl overflow-hidden">
                        <div 
                            className={`h-full ${style.iconBg.replace('/10', '')} transition-all`}
                            style={{ 
